                        ...
                        <div class="row">
                            <div class="col-sm-6 pe-0">
                                <div class="media border-after-xs">
                                    <div class="align-self-center me-3 text-start"><span
                                            class="widget-t mb-1">Sale</span>
                            ...
                            <div>
                                <div class="item"><i class="fa fa-quote-left"></i>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                                        ...
                                        old. Richard McClintock.</p><img class="img-80"
...
&lt;/div&gt;</code></pre>
                ...
                <div class="col-xl-4 col-md-6 box-col-6">
                    <div class="card custom-card">
                        <div class="card-header pb-0"><img class="img-fluid" src="../assets/images/user-card/3.jpg"
                                alt=""></div>
                ...
                <div class="col-xl-4 col-sm-6 col-sm-12">
                    <div class="card browser-widget">
                        <div class="media card-body">
                            <div class="media-img"><img src="../assets/images/dashboard/chrome.png" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card browser-widget">
                        <div class="media card-body">
                            <div class="media-img"><img src="../assets/images/dashboard/firefox.png" alt="">
                            </div>
                            <div class="media-body align-self-center">
                                <div>
                                    <p>Daily </p>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card browser-widget">
                        <div class="media card-body">
                            <div class="media-img"><img src="../assets/images/dashboard/safari.png" alt="">
                            </div>
                            <div class="media-body align-self-center">
                                <div>
                                    <p>Daily </p>
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size d-flex align-items-center"><img
                                                    ...
                                                    <div class="d-inline-block">
                                                        <h6>Holio Mako <span class="text-muted">(250+ Online)</span>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                    ...
                                                    <div class="d-inline-block">
                                                        <h6>Mohsib lara<span class="text-muted">(99+ Online)</span>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                    ...
                                                    <div class="d-inline-block">
                                                        <h6>Hileri Soli <span class="text-muted">(150+ Online)</span>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    <div class="card height-equal">
                        <div class="calender-widget">
                            ...
                            <div class="cal-desc text-center card-body">
                                ...
                                <p>Denouncing pleasure and praising pain was born and I will give you a complete account
                                    of the system, and expound the actual teachings of the great explorer of the
                                    truth,Letraset sheets.</p>
                            </div>
                        </div>
                    </div>
                </div>
